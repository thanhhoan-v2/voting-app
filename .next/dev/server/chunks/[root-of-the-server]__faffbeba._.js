...
"[project]/src/app/api/polls/[id]/comments/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(request, { params }) {
    try {
        ...
        const comments = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2d$actions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["getComments"])(parseInt(resolvedParams.id));
...
async function POST(request, { params }) {
    try {
        ...
        const comment = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2d$actions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["addComment"])(parseInt(resolvedParams.id), displayName, content || null, imageUrl || null);
...
async function DELETE(request, { params }) {
    try {
        ...
        const deletedComment = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2d$actions$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["deleteComment"])(commentId, displayName);
        if (!deletedComment) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__faffbeba._.js.map